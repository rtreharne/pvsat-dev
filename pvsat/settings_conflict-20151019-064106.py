...
EMAIL_USE_TLS = True
EMAIL_HOST = 'mail.cdt-pv.org'
EMAIL_HOST_USER = 'rob@cdt-pv.org'
EMAIL_HOST_PASSWORD = 'Goldbed87'
EMAIL_PORT =25 
DEFAULT_FROM_EMAIL = 'PVSAT Admin <rob@cdt-pv.org'

SITE_URL = 'http://http://127.0.0.1:8000/'
ADMIN_EMAIL = 'rob.treharne@gmail.com'
EMAIL_STATUS= True
